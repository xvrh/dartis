...
class ListPopResultMapper<K extends Object, V extends Object>
    implements Mapper<ListPopResult<K?, V?>> {
  @override
...
class BrpoplpushMapper<V extends Object> implements Mapper<V> {
  @override
