...
class Commands<K extends Object, V extends Object> extends ModuleBase
  ...
  Future<void> clusterAddslots({int? slot, Iterable<int> slots = const []}) =>
      run(<Object?>[r'CLUSTER', r'ADDSLOTS', slot, ...slots]);
  ...
  Future<void> clusterDelslots({int? slot, Iterable<int> slots = const []}) =>
      run(<Object?>[r'CLUSTER', r'DELSLOTS', slot, ...slots]);

  @override
  Future<void> clusterFailover([ClusterFailoverMode? mode]) =>
      run(<Object?>[r'CLUSTER', r'FAILOVER', mode?.name]);

  @override
  Future<void> clusterForget(String nodeId) =>
      run(<Object>[r'CLUSTER', r'FORGET', nodeId]);
  ...
  Future<void> clusterMeet(String ip, int port) =>
      run(<Object>[r'CLUSTER', r'MEET', ip, port]);
  ...
  Future<void> clusterReplicate(String nodeId) =>
      run(<Object>[r'CLUSTER', r'REPLICATE', nodeId]);

  @override
  Future<void> clusterReset([ClusterResetMode? mode]) =>
      run(<Object?>[r'CLUSTER', r'RESET', mode?.name]);

  @override
  Future<void> clusterSaveconfig() => run(<Object>[r'CLUSTER', r'SAVECONFIG']);

  @override
  Future<void> clusterSetConfigEpoch(int configEpoch) =>
      run(<Object>[r'CLUSTER', r'SET-CONFIG-EPOCH', configEpoch]);

  @override
  Future<void> clusterSetslot(int slot, ClusterSetslotCommand command,
          {String? nodeId}) =>
      run(<Object?>[r'CLUSTER', r'SETSLOT', slot, command.name, nodeId]);
  ...
  @override
  Future<void> readonly() => run(<Object>[r'READONLY']);

  @override
  Future<void> readwrite() => run(<Object>[r'READWRITE']);

  // Connection.

  @override
  Future<void> auth(String password) => run(<Object>[r'AUTH', password]);
  ...
  @override
  Future<void> quit() => run(<Object>[r'QUIT']);

  @override
  Future<void> select(int index) => run(<Object>[r'SELECT', index]);

  @override
  Future<void> swapdb(int index1, int index2) =>
      run(<Object>[r'SWAPDB', index1, index2]);
  ...
  Future<List<V?>> hmget(K key, {K? field, Iterable<K> fields = const []}) =>
      runNonNull<List<V?>>(<Object?>[r'HMGET', key, field, ...fields]);
  ...
  Future<void> pfmerge(K destkey,
      ...
      run(<Object?>[r'PFMERGE', destkey, sourcekey, ...sourcekeys]);

  // Keys.

  @override
  Future<int> del({K? key, Iterable<K> keys = const []}) =>
      runNonNull<int>(<Object>[r'DEL', if (key != null) key, ...keys]);

  @override
  Future<List<int>> dump(K key) =>
      runNonNull<List<int>>(<Object>[r'DUMP', key]);

  @override
  Future<int> exists({K? key, Iterable<K> keys = const []}) =>
      runNonNull<int>(<Object>[r'EXISTS', if (key != null) key, ...keys]);

  @override
  Future<int> expire(K key, int seconds) =>
      runNonNull<int>(<Object>[r'EXPIRE', key, seconds]);

  @override
  Future<int> expireat(K key, int timestamp) =>
      runNonNull<int>(<Object>[r'EXPIREAT', key, timestamp]);

  @override
  Future<List<K>> keys(K pattern) =>
      runNonNull<List<K>>(<Object>[r'KEYS', pattern]);
  ...
  Future<int> move(K key, int db) =>
      runNonNull<int>(<Object>[r'MOVE', key, db]);

  @override
  Future<String> object(ObjectSubcommand subcommand, K key) =>
      runNonNull<String>(<Object>[r'OBJECT', subcommand.name, key]);

  @override
  Future<List<String>> objectHelp() =>
      runNonNull<List<String>>(<Object>[r'OBJECT', r'HELP']);

  @override
  Future<int> persist(K key) => runNonNull<int>(<Object>[r'PERSIST', key]);

  @override
  Future<int> pexpire(K key, int milliseconds) =>
      runNonNull<int>(<Object>[r'PEXPIRE', key, milliseconds]);

  @override
  Future<int> pexpireat(K key, int millisecondsTimestamp) =>
      runNonNull<int>(<Object>[r'PEXPIREAT', key, millisecondsTimestamp]);

  @override
  Future<int> pttl(K key) => runNonNull<int>(<Object>[r'PTTL', key]);

  @override
  Future<K> randomkey() => runNonNull<K>(<Object>[r'RANDOMKEY']);

  @override
  Future<void> rename(K key, K newkey) =>
      run(<Object?>[r'RENAME', key, newkey]);

  @override
  Future<int> renamenx(K key, K newkey) =>
      runNonNull<int>(<Object>[r'RENAMENX', key, newkey]);
  ...
  Future<KeyScanResult<K>> scan(int cursor, {K? pattern, int? count}) =>
      runNonNull<KeyScanResult<K>>(<Object?>[
        r'SCAN',
        cursor,
        pattern == null ? null : r'MATCH',
        pattern,
  ...
  Future<List<V>> sort(K key,
    ...
    return runNonNull<List<V>>(<Object?>[
      r'SORT',
      key,
      by == null ? null : r'BY',
      by,
  ...
  Future<int> touch({K? key, Iterable<K> keys = const []}) =>
      runNonNull<int>(<Object?>[r'TOUCH', key, ...keys]);

  @override
  Future<int> ttl(K key) => runNonNull<int>(<Object?>[r'TTL', key]);

  @override
  Future<String> type(K key) => runNonNull<String>(<Object?>[r'TYPE', key]);

  @override
  Future<int> unlink({K? key, Iterable<K> keys = const []}) =>
      runNonNull<int>(<Object?>[r'UNLINK', key, ...keys]);

  @override
  Future<int> wait(int numslaves, int timeout) =>
      runNonNull<int>(<Object>[r'WAIT', numslaves, timeout]);
  ...
  Future<int> linsert(K? key, InsertPosition position, V? pivot, V? value) =>
      runNonNull<int>(<Object?>[r'LINSERT', key, position.name, pivot, value]);

  @override
  Future<int> llen(K? key) => runNonNull<int>(<Object?>[r'LLEN', key]);
  ...
  Future<int> lpush(K? key, {V? value, Iterable<V?> values = const []}) =>
      runNonNull<int>(<Object?>[r'LPUSH', key, value, ...values]);

  @override
  Future<int> lpushx(K? key, V? value) =>
      runNonNull<int>(<Object?>[r'LPUSHX', key, value]);

  @override
  Future<List<V>> lrange(K? key, int start, int stop) =>
      runNonNull<List<V>>(<Object?>[r'LRANGE', key, start, stop]);

  @override
  Future<int> lrem(K? key, int count, V? value) =>
      runNonNull<int>(<Object?>[r'LREM', key, count, value]);

  @override
  Future<void> lset(K? key, int index, V? value) =>
      run(<Object?>[r'LSET', key, index, value]);

  @override
  Future<void> ltrim(K? key, int start, int stop) =>
      run(<Object?>[r'LTRIM', key, start, stop]);
  ...
  Future<int> rpush(K? key, {V? value, Iterable<V?> values = const []}) =>
      runNonNull<int>(<Object?>[r'RPUSH', key, value, ...values]);

  @override
  Future<int> rpushx(K? key, V? value) =>
      runNonNull<int>(<Object?>[r'RPUSHX', key, value]);

  // Pub/Sub.

  @override
  Future<int> publish(K? channel, V message) =>
      runNonNull<int>(<Object?>[r'PUBLISH', channel, message]);

  @override
  Future<List<K>> pubsubChannels({K? pattern}) =>
      runNonNull<List<K>>(<Object?>[r'PUBSUB', r'CHANNELS', pattern]);

  @override
  Future<List<PubsubResult<K?>>> pubsubNumsub(
          {Iterable<K?> channels = const []}) =>
      runNonNull<List<PubsubResult<K?>>>(
          <Object?>[r'PUBSUB', r'NUMSUB', ...channels],
          mapper: PubsubResultMapper<K>());

  @override
  Future<int> pubsubNumpat() => runNonNull<int>(<Object>[r'PUBSUB', r'NUMPAT']);
  ...
  Future<void> scriptDebug(ScriptDebugMode mode) =>
      run(<Object>[r'SCRIPT', r'DEBUG', mode.name]);

  @override
  Future<List<int>> scriptExists(
          {String? sha1, Iterable<String> sha1s = const []}) =>
      runNonNull<List<int>>(<Object?>[r'SCRIPT', r'EXISTS', sha1, ...sha1s]);

  @override
  Future<void> scriptFlush() => run(<Object>[r'SCRIPT', r'FLUSH']);

  @override
  Future<void> scriptKill() => run(<Object>[r'SCRIPT', r'KILL']);

  @override
  Future<String> scriptLoad(String script) =>
      runNonNull<String>(<Object>[r'SCRIPT', r'LOAD', script]);

  // Server.

  @override
  Future<String> bgrewriteaof() =>
      runNonNull<String>(<Object>[r'BGREWRITEAOF']);

  @override
  Future<String> bgsave() => runNonNull<String>(<Object>[r'BGSAVE']);
  ...
  Future<List<Map<String, String>>> clientList() =>
      runNonNull<List<Map<String, String>>>(<Object>[r'CLIENT', r'LIST'],
          mapper: clientListMapper);

  @override
  Future<void> clientPause(int timeout) =>
      run(<Object>[r'CLIENT', r'PAUSE', timeout]);

  @override
  Future<void> clientReply(ReplyMode mode) {
    final command =
        ClientReplyCommand(<Object>[r'CLIENT', r'REPLY', mode.name], mode);
  ...
  Future<void> clientSetname(String connectionName) =>
      run(<Object>[r'CLIENT', r'SETNAME', connectionName]);

  @override
  Future<List<ClientCommand?>> command() =>
      runNonNull<List<ClientCommand?>>(<Object>[r'COMMAND'],
          mapper: commandMapper);

  @override
  Future<int> commandCount() => runNonNull<int>(<Object>[r'COMMAND', r'COUNT']);

  @override
  Future<List<K>> commandGetkeys(List<Object> commandLine) =>
      runNonNull<List<K>>(<Object>[r'COMMAND', r'GETKEYS', ...commandLine]);

  @override
  Future<List<ClientCommand?>> commandInfo(
          {String? commandName, Iterable<String> commandNames = const []}) =>
      runNonNull<List<ClientCommand?>>(
          <Object?>[r'COMMAND', r'INFO', commandName, ...commandNames],
          mapper: commandMapper);

  @override
  Future<Map<String?, String?>> configGet(String parameter) =>
      runNonNull<Map<String?, String?>>(<Object>[r'CONFIG', r'GET', parameter],
          mapper: configMapper);

  @override
  Future<void> configResetstat() => run(<Object>[r'CONFIG', r'RESETSTAT']);

  @override
  Future<void> configRewrite() => run(<Object>[r'CONFIG', r'REWRITE']);

  @override
  Future<void> configSet(String parameter, String value) =>
      run(<Object>[r'CONFIG', r'SET', parameter, value]);

  @override
  Future<int> dbsize() => runNonNull<int>(<Object>[r'DBSIZE']);

  @override
  Future<String> debugObject(K key) =>
      runNonNull<String>(<Object?>[r'DEBUG', r'OBJECT', key]);

  @override
  Future<void> debugSegfault() => run(<Object>[r'DEBUG', r'SEGFAULT']);

  @override
  Future<void> flushall({bool asynchronously = false}) =>
      run(<Object?>[r'FLUSHALL', asynchronously ? r'ASYNC' : null]);

  @override
  Future<void> flushdb({bool asynchronously = false}) =>
      run(<Object?>[r'FLUSHDB', asynchronously ? r'ASYNC' : null]);

  @override
  Future<String> info([InfoSection? section]) =>
      runNonNull<String>(<Object?>[r'INFO', section?.name]);

  @override
  Future<int> lastsave() => runNonNull<int>(<Object>[r'LASTSAVE']);

  @override
  Future<String> memoryDoctor() =>
      runNonNull<String>(<Object>[r'MEMORY', r'DOCTOR']);

  @override
  Future<List<String>> memoryHelp() =>
      runNonNull<List<String>>(<Object>[r'MEMORY', r'HELP']);

  @override
  Future<String> memoryMallocStats() =>
      runNonNull<String>(<Object>[r'MEMORY', r'MALLOC-STATS']);

  @override
  Future<void> memoryPurge() => run(<Object>[r'MEMORY', r'PURGE']);

  @override
  Future<Map<String?, Object?>> memoryStats() =>
      runNonNull<Map<String?, Object?>>(<Object>[r'MEMORY', r'STATS'],
  ...
  @override
  Future<Role> role() =>
      runNonNull<Role>(<Object>[r'ROLE'], mapper: roleMapper);

  @override
  Future<void> save() => run(<Object>[r'SAVE']);

  @override
  Future<void> shutdown([ShutdownMode? mode]) =>
      run(<Object?>[r'SHUTDOWN', mode?.name]);

  @override
  Future<void> slaveof(String host, String port) =>
      run(<Object>[r'SLAVEOF', host, port]);

  @override
  Future<List<SlowLogEntry>> slowlogGet({int? count}) =>
      runNonNull<List<SlowLogEntry>>(<Object?>[r'SLOWLOG', r'GET', count],
          mapper: slowLogMapper);

  @override
  Future<int> slowlogLen() => runNonNull<int>(<Object>[r'SLOWLOG', r'LEN']);

  @override
  Future<void> slowlogReset() => run(<Object>[r'SLOWLOG', r'RESET']);

  @override
  Future<ServerTime> time() =>
      runNonNull<ServerTime>(<Object>[r'TIME'], mapper: timeMapper);

  // Sets.

  @override
  Future<int> sadd(K key, {V? member, Iterable<V> members = const []}) =>
      runNonNull<int>(<Object?>[r'SADD', key, member, ...members]);

  @override
  Future<int> scard(K key) => runNonNull<int>([r'SCARD', key]);

  @override
  Future<List<V>> sdiff(K key, {Iterable<K> keys = const []}) =>
      runNonNull<List<V>>(<Object?>[r'SDIFF', key, ...keys]);

  @override
  Future<int> sdiffstore(K destination, K key, {Iterable<K> keys = const []}) =>
      runNonNull<int>(<Object?>[r'SDIFFSTORE', destination, key, ...keys]);

  @override
  Future<List<V>> sinter(K key, {Iterable<K> keys = const []}) =>
      runNonNull<List<V>>(<Object?>[r'SINTER', key, ...keys]);

  @override
  Future<int> sinterstore(K destination, K key,
          {Iterable<K> keys = const []}) =>
      runNonNull<int>(<Object?>[r'SINTERSTORE', destination, key, ...keys]);

  @override
  Future<int> sismember(K key, V member) =>
      runNonNull<int>(<Object?>[r'SISMEMBER', key, member]);

  @override
  Future<List<V>> smembers(K key) =>
      runNonNull<List<V>>(<Object?>[r'SMEMBERS', key]);

  @override
  Future<int> smove(K source, K destination, V member) =>
      runNonNull<int>(<Object?>[r'SMOVE', source, destination, member]);
  ...
  Future<List<V>> spopCount(K key, int count) =>
      runNonNull<List<V>>(<Object?>[r'SPOP', key, count]);
  ...
  Future<List<V>> srandmemberCount(K key, int count) =>
      runNonNull<List<V>>(<Object?>[r'SRANDMEMBER', key, count]);

  @override
  Future<int> srem(K key, {V? member, Iterable<V> members = const []}) =>
      runNonNull<int>(<Object?>[r'SREM', key, member, ...members]);

  @override
  Future<SetScanResult<V>> sscan(K key, int cursor, {K? pattern, int? count}) =>
      runNonNull<SetScanResult<V>>(<Object?>[
        r'SSCAN',
        key,
        cursor,
        pattern == null ? null : r'MATCH',
  ...
  Future<List<V>> sunion(K key, {Iterable<K> keys = const []}) =>
      runNonNull<List<V>>(<Object?>[r'SUNION', key, ...keys]);

  @override
  Future<int> sunionstore(K destination, K key,
          {Iterable<K> keys = const []}) =>
      runNonNull<int>(<Object?>[r'SUNIONSTORE', destination, key, ...keys]);
  ...
  @override
  Future<int> zcard(K? key) => runNonNull<int>(<Object?>[r'ZCARD', key]);

  @override
  Future<int> zcount(K? key, String min, String max) =>
      runNonNull<int>(<Object?>[r'ZCOUNT', key, min, max]);

  @override
  Future<double> zincrby(K? key, double increment, V? member) =>
      runNonNull<double>(<Object?>[r'ZINCRBY', key, increment, member]);
  ...
  Future<int> zlexcount(K? key, V? min, V? max) =>
      runNonNull<int>(<Object?>[r'ZLEXCOUNT', key, min, max]);
  ...
  Future<int> zrank(K? key, V? member) =>
      runNonNull<int>(<Object?>[r'ZRANK', key, member]);

  @override
  Future<int> zrem(K? key, {V? member, Iterable<V?> members = const []}) =>
      runNonNull<int>(<Object?>[r'ZREM', key, member, ...members]);

  @override
  Future<int> zremrangebylex(K? key, V? min, V? max) =>
      runNonNull<int>(<Object?>[r'ZREMRANGEBYLEX', key, min, max]);

  @override
  Future<int> zremrangebyrank(K? key, int start, int stop) =>
      runNonNull<int>(<Object?>[r'ZREMRANGEBYRANK', key, start, stop]);

  @override
  Future<int> zremrangebyscore(K? key, String min, String max) =>
      runNonNull<int>(<Object?>[r'ZREMRANGEBYSCORE', key, min, max]);
  ...
  Future<int> zrevrank(K? key, V? member) =>
      runNonNull<int>(<Object?>[r'ZREVRANK', key, member]);

  @override
  Future<SortedSetScanResult<K>> zscan(K? key, int cursor,
          {K? pattern, int? count}) =>
      runNonNull<SortedSetScanResult<K>>(<Object?>[
        r'ZSCAN',
        key,
        cursor,
        pattern == null ? null : r'MATCH',
  ...
  Future<double> zscore(K? key, V? member) =>
      runNonNull<double>(<Object?>[r'ZSCORE', key, member]);
  ...
  Future<int> xack(K? key, K? group, {K? id, Iterable<K?> ids = const []}) =>
      runNonNull<int>(<Object?>[r'XACK', key, group, id, ...ids]);
  ...
  Future<int> xdel(K? key, {K? id, Iterable<K?> ids = const []}) =>
      runNonNull<int>(<Object?>[r'XDEL', key, id, ...ids]);
  ...
  Future<Object> xinfo(StreamInfoSubcommand subcommand, {K? key, K? group}) =>
      runNonNull<Object>(<Object?>[r'XINFO', subcommand.name, key, group],
          mapper: StreamInfoMapper<K, V>(subcommand));

  @override
  Future<int> xlen(K? key) => runNonNull<int>(<Object?>[r'XLEN', key]);
  ...
  Future<List<StreamEntry<K?, V?>?>> xrange(K? key, K? start, K? end,
          {int? count}) =>
      runNonNull<List<StreamEntry<K?, V?>?>>(<Object?>[
        r'XRANGE',
        key,
        start,
        end,
  ...
  Future<int> append(K key, V value) =>
      runNonNull<int>(<Object?>[r'APPEND', key, value]);

  @override
  Future<int> bitcount(K key, [int? start, int? end]) {
    assert((start == null && end == null) || (start != null && end != null));
    return runNonNull<int>(<Object?>[r'BITCOUNT', key, start, end]);
  }
  ...
  Future<int> bitop(BitopOperation operation, K destkey,
      ...
      runNonNull<int>(
          <Object?>[r'BITOP', operation.name, destkey, key, ...keys]);

  @override
  Future<int> bitpos(K key, int bit, [int? start, int? end]) =>
      runNonNull<int>(<Object?>[r'BITPOS', key, bit, start, end]);

  @override
  Future<int> decr(K key) => runNonNull<int>(<Object?>[r'DECR', key]);

  @override
  Future<int> decrby(K key, int decrement) =>
      runNonNull<int>(<Object?>[r'DECRBY', key, decrement]);

  @override
  Future<V> get(K key) => runNonNull<V>(<Object?>[r'GET', key]);

  @override
  Future<int> getbit(K key, int offset) =>
      runNonNull<int>(<Object?>[r'GETBIT', key, offset]);

  @override
  Future<V> getrange(K key, int start, int end) =>
      runNonNull<V>(<Object?>[r'GETRANGE', key, start, end]);

  @override
  Future<V> getset(K key, V value) =>
      runNonNull<V>(<Object?>[r'GETSET', key, value]);

  @override
  Future<int> incr(K key) => runNonNull<int>(<Object?>[r'INCR', key]);

  @override
  Future<int> incrby(K key, int increment) =>
      runNonNull<int>(<Object?>[r'INCRBY', key, increment]);

  @override
  Future<double> incrbyfloat(K key, double increment) =>
      runNonNull<double>(<Object?>[r'INCRBYFLOAT', key, increment]);

  @override
  Future<List<V>> mget({K? key, Iterable<K> keys = const []}) =>
      runNonNull<List<V>>(<Object?>[r'MGET', key, ...keys]);
  ...
  Future<void> psetex(K key, int milliseconds, V value) =>
      run(<Object?>[r'PSETEX', key, milliseconds, value]);
  ...
  Future<int> setbit(K key, int offset, int value) =>
      runNonNull<int>(<Object?>[r'SETBIT', key, offset, value]);

  @override
  Future<void> setex(K key, int seconds, V value) =>
      run(<Object?>[r'SETEX', key, seconds, value]);

  @override
  Future<int> setnx(K key, V value) =>
      runNonNull<int>(<Object?>[r'SETNX', key, value]);

  @override
  Future<int> setrange(K key, int offset, V value) =>
      runNonNull<int>(<Object?>[r'SETRANGE', key, offset, value]);

  @override
  Future<int> strlen(K key) => runNonNull<int>(<Object?>[r'STRLEN', key]);
  ...
  @override
  Future<void> unwatch() => run(<Object>[r'UNWATCH']);

  @override
  Future<void> watch({K? key, Iterable<K> keys = const []}) =>
      run(<Object?>[r'WATCH', key, ...keys]);
}
